...
@Component({
    selector: 'app-supplyTypes-reports-reports',
    templateUrl: './supplyTypes-reports.component.html',
    styleUrls:['./supplyTypes-reports.component.scss']
})
export class SupplyTypesReportsComponent implements OnInit {
    ...
    getSupplyTypes(
        ...
        this.exportedReport = [];
        this._reportS.getSupplyTypesReport( 
            date_from,
            date_to,
            order_by_column,
            order_type,
    ...
    exportExcel() {
        ...
        this._exportS.exportExcel(this.report,"تقرير_اجزاء",this.getColoumns())
        setTimeout(() => {
