...
@Component({
    selector: 'app-supplyNames-reports-reports',
    templateUrl: './supplyNames-reports.component.html',
    styleUrls:['./supplyNames-reports.component.scss']
})
export class SupplyNamesReportsComponent implements OnInit {
    ...
    getSupplyNames(
        ...
        this.exportedReport = [];
        this._reportS.getSupplyNamesReport( 
            date_from,
            date_to,
            order_by_column,
            order_type,
    ...
    exportExcel() {
        ...
        this._exportS.exportExcel(this.report,"تقرير_تصنيفات",this.getColoumns())
        setTimeout(() => {
